...
Pod::Spec.new do |spec|
 ...
 # This description is used to generate tags and improve search results.
  ...
  spec.author             = { "Ken Lee" => "zziajkx@126.com" }
  # Or just: spec.author    = "Ken Lee"
  # spec.authors            = { "Ken Lee" => "zziajkx@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Ken Lee"
  ...
  spec.source       = { :git => "https://github.com/likun2019/WZMediaCenter.git", :tag => "#{spec.version}" }
  ...
  spec.dependency "TATMediaSDK", "~> 1.1.1.1"
